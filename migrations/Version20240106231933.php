 ...
 */
final class Version20240106231933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sales_order_line (id INT AUTO_INCREMENT NOT NULL, commande_id INT DEFAULT NULL, amount INT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, discount INT DEFAULT NULL, item VARCHAR(255) DEFAULT NULL, item_description VARCHAR(255) DEFAULT NULL, quantity INT DEFAULT NULL, unit_code INT DEFAULT NULL, unit_description VARCHAR(255) DEFAULT NULL, unit_price INT DEFAULT NULL, vatamount INT DEFAULT NULL, vatpercentage INT DEFAULT NULL, INDEX IDX_93D9398D82EA2E54 (commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

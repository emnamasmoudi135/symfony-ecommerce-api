 ...
 */
final class Version20240107011905 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, item VARCHAR(255) NOT NULL, item_description VARCHAR(255) NOT NULL, unit_code INT DEFAULT NULL, unit_description VARCHAR(255) DEFAULT NULL, unit_price NUMERIC(10, 2) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
